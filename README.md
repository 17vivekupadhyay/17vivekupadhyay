...
- **Software Engineer @ JennaAI** *(Toronto - co-op)* — Early engineer at an investor-backed fintech startup. Shipped core features across React/TypeScript, Django, PostgreSQL, and Azure; integrated Plaid for 180+ linked accounts and 22K+ transactions; helped scale to 500 MAU in 2 months.
